...
if __name__ == '__main__':
    ...
    # stereo parameters
    parser.add_argument('--baseline', type=float, nargs='?', default=0.022, help='meters') # baseline change crop image center after rectify

    # main camera parameters
    parser.add_argument('--fov', type=float, nargs='+', default=None, help='vertical field of view in radians')
    parser.add_argument('--focal', type=float, nargs='+', default=0.0194, help='focal length in meters (fx)') # change default 
...
## 1. Change the default focal in meters. focal in pix / width = focal in meter / sensor size in meter = 7755.5 / 1920 = f / 0.0048, f = 0.0194
## 2. Change baseline in default 22
## 3. Crop or pad the rectified images, shift the image center