...
def initialization():
    ...
    parser.add_argument('--panel',dest="pan", help="With phacon panel or not.", type=bool)
    parser.add_argument('--topic',dest="img_topic", help="Topic of image.", default='/fwd_limage/compressed', type=str)
