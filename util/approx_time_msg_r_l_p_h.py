...
def callback(rimage, limage, pose_pan, pose_camhand):
    global count
    global pub1, pub2, pub3, pub5
    # print('enter')
    # Timestamp info
...
ts = message_filters.ApproximateTimeSynchronizer([rimage_sub, limage_sub, pose_pan_sub, pose_camhand_sub], 50, 0.5)
