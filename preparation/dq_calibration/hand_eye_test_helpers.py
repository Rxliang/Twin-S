...
from python.hand_eye_calibration.dual_quaternion_hand_eye_calibration import (
...
from python.hand_eye_calibration.dual_quaternion import DualQuaternion
from python.hand_eye_calibration.quaternion import Quaternion
